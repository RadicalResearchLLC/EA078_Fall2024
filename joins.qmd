...
#read the data
LA_county <- counties(state = 'CA', cb = T) |>  #pull for California, lower detail level, year = 2022 ) 
  st_transform(crs = 4326) |> 
...
@fig_LAPlaces shows the place and city boundaries in blue, and LA County in red.  
...
Scrape the data using the `read_excel()` function from `readxl`
...
leaflet() |> 
  addProviderTiles(provider = providers$Stadia.AlidadeSmoothDark) |> 
